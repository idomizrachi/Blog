...
struct MainRunner {
    func run() throws {
        ...
        Greeting.run()
        createOutputPath(outputPath: outputPath, outputCssPath: outputCssPath, outputImagesPath: outputImagesPath)
...
//        try CopyResources(templatesResourcesPath: templateImagesPath, buildPath: outputImagesPath).run()
    ...
    private func createOutputPath(outputPath: String, outputCssPath: String, outputImagesPath: String) {
        do {
